<?php
    ...
    (SELECT image FROM flutter_barang WHERE id_barang = a.id_barang) AS gambar FROM flutter_shopping_cart a WHERE a.userid = '$userid' AND id_barang in (SELECT id_barang FROM flutter_barang) GROUP BY a.id_barang";
